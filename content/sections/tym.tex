...
The doublet theorem guarantees that no observable can be made out of these quantities --- terms containing $\bar{c}$, $b$, $\bar{\chi}$, $B$, $\bar{\phi}$, and/or $\bar{\eta}$ are, at most, $s$-boundaries. Following this spirit, we define the (A){}SDL gauge fixing action as
